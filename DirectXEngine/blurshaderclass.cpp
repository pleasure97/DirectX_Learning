...
bool BlurShaderClass::Render(ID3D11DeviceContext* deviceContext, int indexCount, 
    ...
    int screenWidth, int screenHeight, float blurType)
{
    bool result; 
    ...
    int screenWidth, int screenHeight, float blurType)
{
    ...
    // Get a pointer to the data into the matrix constant buffer. 
    ...
    // Now set the matrix constant buffer in the vertex shader with the updated value.
