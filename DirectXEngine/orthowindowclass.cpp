...
{
	// Put the vertex and index buffers on the graphics pipieline to prepare them for drawing.
...
bool OrthoWindowClass::InitializeBuffers(ID3D11Device* device, int windowWidth, int windowHeight)
{
	...
	// Calcualte the screen coordinates of the right side of the window.
	...
	// Load the vertex array with the data.
	// First triangle.
