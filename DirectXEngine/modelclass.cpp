...
void ModelClass::CalculateModelVectors()
{
	...
	{
		// Get the 3 vertices for this face from the model. 
...
void ModelClass::CalculateTangentBinormal(TempVertexType vertex1, TempVertexType vertex2, TempVertexType vertex3, VectorType& tangent, VectorType& binormal)
{
	...
	tuVector[1] = vertex2.tv - vertex1.tv;

	tuVector[1] = vertex3.tu - vertex1.tu; 
	tuVector[1] = vertex3.tv - vertex1.tv; 

	// Calculate the denominator of the tangent and binormal equation. 
	den = 1.f / (tuVector[0] * tuVector[1] - tuVector[1] * tvVector[0]); 
